...
<body>
    ...
    <main class="container text-center primary">
        <div class="row">
            <div class="col-12 display-4 my-2 text-left">
                <h1>Caixa</h1>
                <hr />
            </div>
            <form class="col-sm-12 col-md-6" action="finalizaCompras.php" method="POST" enctype="multipart/form-data"
            ...
            <div class="container col-sm-12 col-md-6">
                <img class="img-fluid mb-4" width="90px" src="" id="fotoCx" alt="Foto do produto">
