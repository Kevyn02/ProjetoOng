<?php
    ...
    WHERE a.id_doacao = c.id_doacao AND b.id_produto = c.id_produto AND a.data BETWEEN '".$datainicial->format('Y-m-d')." 00:00:00' AND '".$datafinal->format('Y-m-d')." 23:59:59' ORDER BY data ASC";
